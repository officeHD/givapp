		...
		<div class="list">
			...
			<div class="sub-list valid" :class="subState">
				...
				<div class="row" v-for="(row,index) in couponValidList" :key="index" >
					...
					<!-- content -->
					<div class="carrier" :class="[typeClass=='valid'?theIndex==index?'open':oldIndex==index?'close':'':'']" @touchstart="touchStart(index,$event)" @touchmove="touchMove(index,$event)" @touchend="touchEnd(index,$event)">
						<div class="left">
							<div class="title">
								{{row.title}}
							</div>
			...
			<div class="sub-list invalid" :class="subState">
				...
				<div class="row" v-for="(row,index) in couponinvalidList" :key="index" >
					...
					<!-- content -->
					<div class="carrier" :class="[typeClass=='invalid'?theIndex==index?'open':oldIndex==index?'close':'':'']" @touchstart="touchStart(index,$event)" @touchmove="touchMove(index,$event)" @touchend="touchEnd(index,$event)">
						<div class="left">
							<div class="title">
								{{row.title}}
							</div>
