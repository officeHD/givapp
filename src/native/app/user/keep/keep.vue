           ...
           @touchstart="touchStart(index,$event)" @touchmove="touchMove(index,$event)" @touchend="touchEnd(index,$event)">
			...
			<div class="sub-list shop" :class="subState">
				...
				<div class="row" v-for="(row,index) in shopList" :key="index" >
					...
					<!-- content -->
					<div class="carrier" :class="[typeClass=='shop'?theIndex==index?'open':oldIndex==index?'close':'':'']" @touchstart="touchStart(index,$event)" @touchmove="touchMove(index,$event)" @touchend="touchEnd(index,$event)">
						<div class="left">
							<image :src="row.img"></image>
						</div>
						<div class="right">
