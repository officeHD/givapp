	...
	<div class="shopAlert" ref="shopAlert" @click="e=>e.stopPropagation()">  
		<div class="alertTop">
			...
			<div class="goodsTit">
				...
				<text class="intro">AJOY SAHU Baggage Girls 2019 New Style Small Popular Design Baggage Girls with Skewed Skin and Single Shoulder Baggage Girls</text>
			</div>
		</div> 
  ...
  data() {
    return {
      ...
      goodsData: {
        id: 1,
        name:
          "AJOY SAHU Baggage Girls 2019 New Style Small Popular Design Baggage Girls with Skewed Skin and Single Shoulder Baggage Girls",
        price: "52.3",
        discount: "80%",
        number: 1,
        service: [
