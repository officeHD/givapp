<template>
  <div>
    <scroller class="scroller">
      <div class="imgDemo">
        ...
        <div class="swiper-box">
          <slider class="slider" interval="3000" auto-play="true" v-if="goodInfo.thumb_url">
        ...
        <div class="info-box goods_top">
          <div class="top_left">
            ...
            <text class="goods-old_price">{{goodInfo.old_price}}</text>
        ...
        <div class="userInfo">
          ...
          <div class="userCenter" v-if="reviewList.nickname">
            <div class="row userMsg">
              <image class="userAvator" :src="reviewList.headimgurl" />
    ...
    <div class="shopAlert" ref="shopAlert" @click="e=>e.stopPropagation()">
      <div class="alertTop">
        <image class="goodsImg" :src="goodInfo.thumb" />
        <div class="goodsTit">
      ...
      <scroller class="alertScroll">
        <div class="styleBox" v-for="(item,index) in shopSpec" :key="index">
          <text class="styleTitle">{{item.title}}</text>
          <div class="itemBox">
            <text
              class="styleItem"
              v-for="itemSpe in item.content"
              :key="itemSpe.id"
              :class="[itemSpe.id==selectSpec[index]?'styleActive':'']"
              @click="selectSp(index,itemSpe.id)"
            >{{itemSpe.name}}</text>
          </div>
        </div>
    ...
    <div class="parmarAlert" ref="parmarAlert" @click="e=>e.stopPropagation()">
      ...
      <scroller class="alertScroll">
        <div class="parmarList" v-for="item in  goodParmar" :key="item.title">
      ...
      let data = [
        {
          ...
          goods_id: this.goodId,
          thumb: this.goodInfo.thumb,
          price: this.goodInfo.price,
          title: this.goodInfo.title,
          id: this.goodInfo.id,
          total_price: this.goodInfo.total_price,
          goods_type: this.goodInfo.goods_type
        }
      ];
