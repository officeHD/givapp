...
<div class="wrapper">
  ...
  <image class="imgbg" :src="userInfo.headimgurl" resize="cover" />
  <div class="imgMask"></div>
  <div class="userInfo">
    <image class="userAvator" :src="userInfo.headimgurl" />
    ...
    <div class="recontent">
      <div class="reitem" v-for="item in secondList" :key="item">
        <image
          class="goodsImga"
          :src="item.thumb"
          @click="gonext('root:app/goods/goods2.js',{id:item.id})"
        />
...
<script>
import { get_users_info, get_goods_list } from "../../mixin/ajax.js";
