	...
	<div class="wrapper">
		...
		<scroller>
			<div class="stepBox">
				...
				<text class="cicle">2</text>
				<text class="cicle">3</text>
				<text class="cicle">4</text>
				<div class="ciclebox">
					<text class="step1 activeStep">Unpaid</text>
					<text class="step2">Waiting for shipping</text>
					<text class="step3">Shipped</text>
					<text class="step4">Successful trade</text>
				</div>
			</div>
			...
			<div class="section1">
				...
				<div class="waitShip">
					<div class="orderMes">
						...
						<text class="shipTime">5 days, 23 hours, 59 minutes, the system will automatically cancel the transaction, please
							ship as soon as possible</text>
						<text class="buyers">Yu Yaping</text>
						<text class="buyAddress">Unit 401, Building X, Chessboard X, Lixia District,Jinan City,Shandong Province,China</text>
				...
				<div class="secCon">
					...
					<div class="conSec">
						<image class="goodImg" src="root:img/goods.png"></image>
						<div class="goodInfo">
							<text class="goodsName">Shorts</text>
					...
					<text class="orderTime">Order time：2019-06-24 15:25:49</text>
					<text class="orderTime">Payment time：2019-06-24 15:25:49</text>
					<text class="orderTime">Trading method：Delivery</text>
