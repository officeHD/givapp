...
const QADB = [
    ...
    options: [
      {
        nextQid: 200001,
        title: "Report Bug",
        content: `I found a bug of Weex!`
      },
      {
        nextQid: 300001,
        title: "Ask Questions",
        content: `I want to ask some questions about Weex.`
      },
    ...
    options: [
      {
        nextQid: 210001,
        title: "Styles",
        content: "Something wrong with the style."
      },
  ...
  },
  {
    ...
    options: [{ nextQid: 230001, title: "No", content: "No, how do I get it?" }]
  },
  {
    qid: 230001,
    content: `Scan the QR code can get the env message of your phone.`,
    options: [{ nextQid: 240001, title: "OK" }]
  },
  {
    qid: 240001,
    content: `Can you offer an example to reproduce that bug?`,
    options: [{ nextQid: 900000, title: "OK" }]
  },
  {
    qid: 300001,
    ...
    options: [
      {
        nextQid: 900002,
        title: "About Weex",
        content: "I want to know something about Weex."
      },
  ...
  },
  {
    ...
    options: [{ reset: true, nextQid: 100001, title: "All right" }]
  },
  {
    qid: 900001,
    doNotRecord: true,
  ...
  },
  {
    ...
    options: [{ nextQid: 400001, title: "←_←" }]
  },
  {
    qid: 999999,
...
export default {
  ...
  created() {
    ...
    globalEvent.addEventListener("onPageInit", function(e) {
      ...
      if (!param) return;
      (s.title = "与" + param["title"] + "聊天中"), (s.headUrl = param["url"]);
    });
  },
  methods: {
    reply(feedback) {
    ...
    sendUserMessage(message) {
      if (message) {
        ...
        this.scrollToBottom();
        judge(this.chatMessages).then(result => {
          this.reply(result);
        });
      }
    },
