<template>
	<div>
        <div class="chat-list">
			<div class="chat" v-for="(chat,index) in chatList" :key="index">
				<div class="row" @tap="toChat(chat)">
					<div class="left">
						<img :src="chat.face"></img>
					</div>
					<div class="right">
						<div class="top">
						...
						<div class="bottom">
							...
							<div class="tis" v-if="chat.tisNum>0">{{chat.tisNum}}</div>
						</div>
					</div>
				</div>
			</div>
